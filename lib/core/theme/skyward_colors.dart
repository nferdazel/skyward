...
/* ═══════════════════════════════════════════════════════
   SKYWARD CHROMATIC — Color Token System v3.0
   Base: GitHub Primer (github.com/primer/primitives)
   Mutation: accent shifted to Ice Blue (dark) / Deep Blue (light)
   Semantic colors: GitHub-derived, battle-tested for dense UI
═══════════════════════════════════════════════════════ */
...
class SkywardColors {
  ...
  static const darkSurface3  = Color(0xFF21262D);
